...
За секој вработен се чува неговото име, презиме, ЕМБГ, корисник кој што го додал неговата плата. 
Еден вработен може да работи во само еден маркет. 
	...
	•	Откако еден вработен ќе биде дефиниран и зачуван, истиот може да се промени и избрише само од корисникот кој го креирал вработениот. 
За контакт информациите се чува улицата и бројот на којшто се наоѓа маркетот, телефонскиот број и емаил адресата. 
	•	За маркетите во листата се прикажуваат само нивните имиња, додека за вработените име и презиме. 
...
За производите се знае во кои маркети се достапни како и достапната количина во секој од маркетите. 
	...
	•	Производите може да се филтрираат според видот и според тоа дали се увезени или не. За секој модел да се напише соодветната def str self метода.